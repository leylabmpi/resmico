...
DATA_DIR="/cluster/work/grlab/projects/projects2019-contig_quality/data/CAMI/CAMI2_HMP-skin/"
...
# submit the job
bsub -W 4:00 -n 4 -J resmico-n9k -R "span[hosts=1]" -R rusage[mem=10000,ngpus_excl_p=2,scratch=30000] -G ms_raets \
