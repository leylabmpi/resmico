...
features_small="ref_base num_query_A num_query_C num_query_G num_query_T num_proper_Match num_orphans_Match num_proper_SNP num_SNPs num_discordant mean_al_score_Match"
