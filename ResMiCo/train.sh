...
cmd1="echo Creating scratch directory...; rm -rf /scratch/features/; mkdir /scratch/features"
...
features_small="ref_base num_query_A num_query_C num_query_G num_query_T num_SNPs" 
