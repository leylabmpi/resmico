...
class TestBinaryDataEval(unittest.TestCase):
    def test_batching_one_per_batch(self):
        ...
        indices = np.arange(len(reader))
        eval_data = Models_FL.BinaryDataEval(reader, indices, ContigReader.feature_names, 500, 250, 1010)
    ...
    def test_batching_multiple_per_batch(self):
        ...
        indices = np.arange(len(reader))
        eval_data = Models_FL.BinaryDataEval(reader, indices, ContigReader.feature_names, 250, 200, 1000)
